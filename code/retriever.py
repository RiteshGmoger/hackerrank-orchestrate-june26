...
def retrieve(query: str,domain: str,corpus: list[dict],bm25: Optional[BM25Okapi]) -> list[RetrievalResult]:
    """
    ...
    if not domain_corpus:
        domain_corpus = corpus  # search full corpus on unknown domain
